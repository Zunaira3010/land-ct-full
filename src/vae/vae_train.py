...
def main(args):
    ...
    # ===== FIX: Recovery checkpoint OUTSIDE timestamp folder =====
    checkpoint_path = os.path.join(args.model_dir, "checkpoint_last.pt")
    # =============================================================
    ...
    if os.path.exists(checkpoint_path):
        try:
            ...
            logging.warning("Starting a fresh training run.")
    # ==========================================================

    # Setup validation inferer (unchanged)
    ...
    for epoch in tqdm(range(start_epoch, args.n_epochs), desc="Training Epochs", unit="epoch"):
        ...
        # FIX: use correct scalar
        tensorboard_writer.add_scalar("scale_factor/train", scale_factor_train, epoch)
        ...
        # ==========================================================
        # Save recovery checkpoint at end of epoch
        # ==========================================================
        checkpoint = {
            "epoch": epoch,
        ...
        logging.info(f"Saved recovery checkpoint to {checkpoint_path}")
        # ==========================================================
